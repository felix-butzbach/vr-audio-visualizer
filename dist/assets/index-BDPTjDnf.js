...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function ta(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yr(),fragmentShader:`
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function na(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yr(),fragmentShader:`
...
`].filter(ri).join(`
`)),o=Br(o),o=ha(o,t),o=da(o,t),a=Br(a),a=ha(a,t),a=da(a,t),o=fa(o),a=fa(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(A=`#version 300 es
